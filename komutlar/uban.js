...
exports.run = (client, message, args) => {
  if (!message.member.roles.has('BAN SORUMLUSU ROLÜ') && !message.member.hasPermission('ADMINISTRATOR')) return message.channel.send('Bu komutu kullanmak için **Ban Hammer** yetkin olması gerekiyor.!')
